...
$forwardedNames = @(
    ...
    'ENABLE_MOSDNS','ENABLE_DOCKERMAN','ENABLE_QMODEM_NEXT','ENABLE_QMODEM','ENABLE_QMODEM_LUA',
    'ENABLE_HOMEPROXY','ENABLE_ADBYBY_PLUS','ENABLE_ORIGINAL_MODEM','ENABLE_EASYMESH','ENABLE_ADBLOCK',
